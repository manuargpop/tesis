...
def create_pdf(filename):
    ...
    def icc_texto(icc):
        if icc == "androide":
            return f"usted tiene mayor riesgo para el desarrollo de \n\n\n       " \
                   f"enfermedades crónico-degenerativas debido a la acumulación de grasa visceral"
        elif icc == "ginecoide":
    ...
    def mlg_medic(mlg, sexo):
        ...
        if sexo == "hombre":
            ...
            if dato2 == 25:
                print("No se logra normalmente sin levantar pesas / Límite superior de la musculatura obtenida sin uso "
